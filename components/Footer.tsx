      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <Link href="/" className="group inline-block">
              ...
              >
                <div className="relative">
                  <div className="absolute inset-0 bg-red-600 blur-lg opacity-20 group-hover:opacity-100 transition-opacity" />
        ...
        <div className="pt-10 border-t border-zinc-900 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-6 text-[10px] font-bold text-zinc-600 tracking-widest uppercase">
            <span>© {currentYear} SJC • IT DEPT</span>
            <span className="hidden md:block">|</span>
            <span className="hover:text-red-600 cursor-pointer transition-colors">V_2.0.25_STABLE</span>
          </div>
